...
variable "asg_instance_refresher" {
  description = "Start a 'aunch-before-terminate asg instance refresh using the latest launch template automatically after the launch template user_data or image_id has been modified."
  type        = bool
  default     = false
}
